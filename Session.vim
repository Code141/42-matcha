...
328
normal! zo
let s:l = 118 - ((42 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
...
11
normal! zc
let s:l = 58 - ((57 * winheight(0) + 38) / 76)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
...
setlocal fdn=20
setlocal fen
let s:l = 33 - ((18 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
...
setlocal fdn=20
setlocal fen
let s:l = 29 - ((18 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
351
normal! zo
let s:l = 340 - ((86 * winheight(0) + 38) / 76)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
340
